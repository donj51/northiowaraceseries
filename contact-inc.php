...
#  insert your Site Key and Site Secret Key in the two variables below
 ...
 $recaptchaSiteKey =   '6LehMFIUAAAAALTP_fCM3UJoF1PEnhgnMN87bqnk';   // your reCaptcha site key
 $recaptchaSecretKey = '6LehMFIUAAAAAIQNNkr14eHHOo_Xitcsptio_X3p';   // your reCaptcha site secret key
...
# Optional log file.  use '' as the name if a log file is not desired.
 ...
 $mailto = 'don$northiowaraceseries,com';

 # Site Name / Title
 $sitename = 'NortIowaRaceSeries';
...
print "<!-- contact-inc.php V2.00 - 07-Apr-2018 -->\n";
?>
